...
public class PrescribeFoodDialogFragment extends android.support.v4.app.DialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        quantityTextBox = new TextBox(getString(R.string.prescription_label), getString(R.string.prescription_unit), TextBox.INPUT_NUMBER);
    ...
    private void saveIntoFirebase(Recomentation recomentation){
        ...
        try {
            ...
            mDbRef.child(recomentation.getId()).child(FirebaseHelper.QUANTIDADE_KEY).setValue(((Alimentacao) recomentation.getAction()).getQuantity());
