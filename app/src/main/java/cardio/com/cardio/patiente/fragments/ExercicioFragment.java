...
public class ExercicioFragment extends Fragment {
    ...
    private CaixaDeTexto mCaixaDeTextoExercise;
    private CaixaDeTexto mCaixaDeTextoIntensity;
    private CaixaDeTexto mCaixaDeTextoDuration;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mCaixaDeTextoExercise = new CaixaDeTexto("Atividade física", "", CaixaDeTexto.INPUT_TEXT);
        mCaixaDeTextoExercise.setHint("Caminhada");
        mItems.add(mCaixaDeTextoExercise);

        mCaixaDeTextoIntensity = new CaixaDeTexto("Intensidade", "", CaixaDeTexto.INPUT_TEXT);
        mCaixaDeTextoIntensity.setHint("Leve");
        mItems.add(mCaixaDeTextoIntensity);

        mCaixaDeTextoDuration = new CaixaDeTexto("Duração", "min", CaixaDeTexto.INPUT_NUMBER);
